package com.ogutcenali.fallback;
...
public class FallbackController {
    ...
    @GetMapping("/fallbackbook")
    public ResponseEntity<String> fallbacketicaret(){
        return ResponseEntity.ok("Book Servis geçici bir süre devre dışıdır lütfen daha sonra tekrar deneyiniz.");
    }
